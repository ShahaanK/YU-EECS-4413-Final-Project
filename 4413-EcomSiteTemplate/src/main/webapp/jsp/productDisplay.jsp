...
<body>
	...
	<div class="product-grid">
		<c:forEach var="item" items="${randomItems}">
			<div class="product">
				...
				<div class="product-details">
					...
					<form action="CartServlet" method="post">
						<input type="hidden" name="action" value="add"> <input
							...
							value="<c:out value='${item.productName}' />"> <input
							type="hidden" name="colour"
							value="<c:out value='${item.colour}' />"> <input
							type="hidden" name="quantity"
							value="<c:out value='${item.quantity}' />"> <input
							type="hidden" name="price"
							value="<c:out value='${item.price}' />"> <input
							type="hidden" name="image"
							value="<c:out value='${item.image}' />"> <input
							type="hidden" name="category"
							value="<c:out value='${item.category}' />"> <input
							type="hidden" name="brand"
